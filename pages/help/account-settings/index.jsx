...
const accountSetting = () => {
    return (
        <>
            ...
            <div className={styles.page_full_handle}>
                <div className="pu_container">
                    <div className={styles.pu_wr}>
                        <h3 className={styles.page_heading}>Account Settings</h3>
            ...
            <div className="pu_container">
                <div className={`${styles.help_main} ${styles.pu_account_settings}`}> 
                    <Link href="/help/account-settings/forgot-password"><a> Forgot your password</a></Link>
                    <Link href="/help/account-settings/reset-password"><a>How to reset my account password</a></Link>
                </div>
            </div>
        </>
